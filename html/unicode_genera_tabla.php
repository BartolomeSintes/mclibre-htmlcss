  ...
  <body>
        ...
        if ($numcod == 1) {
          if (count($c[0]) == 1 && hexdec($c[0][0]) >= hexdec($inicial) && hexdec($c[0][0]) <= hexdec($final)) { // no sé si es necesario convertirlo a decimal, pero por si acaso
            ...
            if ($c[2] == "emojione") {
              ...
              print "          <span class=\"eo\"><a href=\"https://github.com/Ranks/emojione/tree/master/assets/svg/$tmp.svg\">&#x" . $c[0][0] . ";</a></span>\n";
            } else {
          ...
          if (count($c[0]) == 2 && hexdec($c[0][0]) >= hexdec($inicial) && hexdec($c[0][0]) <= hexdec($final)) { // no sé si es necesario convertirlo a decimal, pero por si acaso
            ...
            if ($c[2] == "emojione") {
              ...
              print "          <span class=\"eo\"><a href=\"https://github.com/Ranks/emojione/tree/master/assets/svg/$tmp0-$tmp1.svg\">&#x" . $c[0][0] . ";&#x200D;&#x" . $c[0][1] . ";</a></span>\n";
            } else {
          ...
          if (count($c[0]) == 3 && hexdec($c[0][0]) >= hexdec($inicial) && hexdec($c[0][0]) <= hexdec($final)) { // no sé si es necesario convertirlo a decimal, pero por si acaso
            ...
            if ($c[2] == "emojione") {
              ...
              print "          <span class=\"eo\"><a href=\"https://github.com/Ranks/emojione/tree/master/assets/svg/$tmp0-$tmp1-$tmp2.svg\">&#x" . $c[0][0] . ";&#x200D;&#x" . $c[0][1] . ";&#x" . $c[0][2] . ";</a></span>\n";
            } else {
    ...
    function genera_tabla_colores_piel($grupo, $id, $pdf, $numcod, $inicial, $final) {
      ...
      foreach ($caracteres_colores_piel as $c) {
        ...
        print "          <td><span class=\"eo\"><a href=\"https://github.com/Ranks/emojione/tree/master/assets/svg/$tmp.svg\">&#x" . $c[0][0] . ";</a></span></td>\n";
        print "          <td><span class=\"eo\"><a href=\"https://github.com/Ranks/emojione/tree/master/assets/svg/$tmp-1f3fb.svg\">&#x" . $c[0][0] . ";&#x200D;&#x1F3FB;</a></span></td>\n";
        print "          <td><span class=\"eo\"><a href=\"https://github.com/Ranks/emojione/tree/master/assets/svg/$tmp-1f3fc.svg\">&#x" . $c[0][0] . ";&#x200D;&#x1F3FC;</a></span></td>\n";
        print "          <td><span class=\"eo\"><a href=\"https://github.com/Ranks/emojione/tree/master/assets/svg/$tmp-1f3fd.svg\">&#x" . $c[0][0] . ";&#x200D;&#x1F3FD;</a></span></td>\n";
        print "          <td><span class=\"eo\"><a href=\"https://github.com/Ranks/emojione/tree/master/assets/svg/$tmp-1f3fe.svg\">&#x" . $c[0][0] . ";&#x200D;&#x1F3FE;</a></span></td>\n";
        print "          <td><span class=\"eo\"><a href=\"https://github.com/Ranks/emojione/tree/master/assets/svg/$tmp-1f3ff.svg\">&#x" . $c[0][0] . ";&#x200D;&#x1F3FF;</a></span></td>\n";
        print "        </tr>\n";
      }
      print "      </table>\n";
      print "    </section>\n";
