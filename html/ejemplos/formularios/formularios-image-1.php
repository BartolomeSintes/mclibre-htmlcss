...
<html lang="es">
  ...
  <body>
    <form action="formularios_image_2.php" method="get">
<?php
$radio = rand(10, 20);
$cx = rand(20, 80);
$cy = rand(20, 80);
print "      <p>Haga clic en el círculo negro o fuera de él:\n";
print "        <input type=\"image\" name=\"dato\" src=\"formularios_image.php?radio=$radio&amp;cx=$cx&amp;cy=$cy\" style=\"vertical-align: top;\" />\n";
