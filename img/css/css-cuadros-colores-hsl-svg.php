...
for ($s = 0; $s <= 100; $s = $s + $paso) {
    for ($l = 0; $l <= 100; $l = $l + $paso) {
        print "  <rect x=\"$s\" y=\"$l\" width=\"" . $paso + 1 . "\" height=\"" . $paso + 1 . "\" stroke=\"none\" fill=\"hsl($h $s% $l%)\" />\n";
...
print "  <text x=\"45\" y=\"-20\" font-size=\"18\" text-anchor=\"middle\">S</text>\n";
...
print "  <text x=\"-30\" y=\"50\" font-size=\"18\" text-anchor=\"middle\">L</text>\n";
